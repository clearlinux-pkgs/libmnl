...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605558075
...
cp %{_builddir}/libmnl-1.0.4/COPYING %{buildroot}/usr/share/package-licenses/libmnl/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd ../build32/
%make_install32
